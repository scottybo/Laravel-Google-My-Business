...
class GoogleMyBusiness extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $v1UpdateMyBusinessInformation = $this;
        $v1UpdateMyBusinessInformation->rootUrl = 'https://mybusinessbusinessinformation.googleapis.com/';
        $v1UpdateMyBusinessInformation->servicePath = '';
        $v1UpdateMyBusinessInformation->version = 'v1';
        $v1UpdateMyBusinessInformation->serviceName = 'mybusinessbusinessinformation';

        $this->accounts_locations_v1 = new Google_Service_MyBusiness_AccountsLocations_Resource(
            $v1UpdateMyBusinessInformation,
            $v1UpdateMyBusinessInformation->serviceName,
            'locations',
            array(
                'methods' => array(
                    'associate' => array(
                    ...
                    ),'clearLocationAssociation' => array(
        ...
        $this->attributes_v1 = new Google_Service_MyBusiness_Attributes_Resource(
            $v1UpdateMyBusinessInformation,
            $v1UpdateMyBusinessInformation->serviceName,
            'attributes',
            array(
...
class Google_Service_MyBusiness_AccountsLocations_Resource extends Google_Service_Resource
{
    ...
    public function get($name, $optParams = array())
    {
        $params = array_merge(array('name' => strstr($name, 'locations/')), array('readMask' =>
...
class Google_Service_MyBusiness_ListLocationsResponse extends Google_Collection
{
    ...
    public function getLocationPrimaryCategoryByLocation($location)
    {
        if (isset($location['categories']['primaryCategory'])){
            $location['categories']['primaryCategory']['categoryId'] = $location['categories']['primaryCategory']['name'];
